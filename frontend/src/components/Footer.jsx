...
const Footer = () => {
  ...
  return (
    <div className="h-full w-full text-white">
      <div className="h-full p-8 bg-indigo-950">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-gray-300">{data.mobile}</p>
                </div>
              </div>
              <div className="flex items-center">
      ...
      <div className="bg-sky-800 w-full h-16 flex items-center justify-center font-semibold">
        Copyright © 2024 All rights reserved,&nbsp; <a href="https://www.loansmarket.co.in" className="text-gray-200 hover:underline"> loans market</a>&nbsp; | Designed with ❤ by&nbsp;
