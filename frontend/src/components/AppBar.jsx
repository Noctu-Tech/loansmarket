...
const AppBar = () => {
  ...
  return (
    <nav className="navbar">
      <div className='free-nav-container flex items-center justify-between pr-10'><div className='flex'>
        <div className="flex text-blue-950"><PhoneInTalkOutlinedIcon/><span>+91 9915589863</span></div>
        <div className='flex text-blue-950'><EmailOutlinedIcon/><span>business@noctu.tech</span></div></div>
